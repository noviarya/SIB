										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<a href="modalEditKategori{{ $row->id}}" data-togle="modal" class="btn btn-primary btn-xs"><i class
														="fa fa-edit"></i> Edit</a>
                                                        <a href="modalHapusKategori{{ $row->id}}" data-togle="modal"class="btn btn-danger btn-xs"><i class
