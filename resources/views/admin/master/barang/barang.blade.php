										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												<tr>
                                                    ...
                                                    <td>{{ $row->stok }}Unit</td>
													<td>
														<a href="modalEditBarang{{ $row->id}}" data-togle="modal" class="btn btn-primary btn-xs"><i class
														="fa fa-edit"></i> Edit</a>
                                                        <a href="modalHapusBarang{{ $row->id}}" data-togle="modal"class="btn btn-danger btn-xs"><i class
														="fa fa-trash"></i> Hapus</a>
													</td>
												</tr>
												@endforeach
											</tbody>
		...
		<div class="modal-content">
            ...
            <div class="modal-body">
				<div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_barang" placeholder="Nama Lengkap ..." required>
                </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
					...
					<div class="input-group mb-3">
						...
						<input type="number" value="{{ $d->harga }}" lass="form-control" placeholder="Harga...." name="harga" required>
					</div>
				</div>
