										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												<tr>
                                                    ...
                                                    <td>{{ $row->level }}</td>
													<td>
														<a href="modalEditUser{{ $row->id}}" data-togle="modal" class="btn btn-primary btn-xs"><i class
														="fa fa-edit"></i> Edit</a>
                                                        <a href="modalHapusUser{{ $row->id}}" data-togle="modal"class="btn btn-danger btn-xs"><i class
